...
class XPathFunctionsProvider implements ExtensionsProvider {
     ...
     */
    public Object extFunction(String ns, String funcName, List<XObject> argVec, Object methodKey) throws TransformerException {
        XPathFunction func = getFunction(ns, funcName);
        if (func != null) {
            try {
                return func.execute(new Vector<Object>(argVec));
            }
            catch (Exception e) {
	...
	public Object extFunction(FuncExtFunction funcExtFunction, List<XObject> vec) throws TransformerException {
		// return null;
