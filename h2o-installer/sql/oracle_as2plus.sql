...
CREATE TABLE message (
  ...
  original_message_id varchar2(255), -- message_id of the message that the receipt replies to 
  primal_message_id varchar2(255),-- The message_id of message which triggered "Resend as New Message"
