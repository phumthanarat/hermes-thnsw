      ...
      <tr>
        ...
        <td width="30%">
            <input type="datetime-local" name="from_time">
                <xsl:attribute name="value"><xsl:value-of select="/message_history/search_criteria/from_time" /></xsl:attribute>
            </input>
        </td>
        <td width="20%">To</td>
        <td width="30%">
            <input type="datetime-local" name="to_time">
                <xsl:attribute name="value"><xsl:value-of select="/message_history/search_criteria/to_time" /></xsl:attribute>
            </input>
        </td>
      </tr>
      <tr>
...
<table border="0" cellpadding="2" cellspacing="2" width="100%">          
  ...
  <tr>
    <td width="40%">
        <xsl:choose>
            <xsl:when test="./status='PD' or ./status='PR'">
                <input type="checkbox" disabled="disabled" style="margin-right:6px;"
